...
\begin{figure*}
  ...
  \begin{tabular}[b]{c|c|c|c|c}
    ...
    Eberswalde Crater &       ESP\_020324\_1555\supcite{bib:ESP_020324_1555} & 1.64e+08 & 1.008208 & $\SI{110.22}{\kilo\meter\squared}$\\
...
\section{Results}
\label{sec:results}
% Southwest Arabia Terra &  ESP_011844_1855
% Gale Crater &             ESP_023957_1755
% Holden Crater &           ESP_019612_1535
% Eberswalde Crater &       ESP_019757_1560
% Mawrth Vallis &           ESP_015985_2040
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.27\textwidth}
    \centering
    \includegraphics[height=0.4\paperheight]{figures/maps/ESP_020324_1555/DTEEC_020324_1555_020390_1555_U01.jpg}
    \caption{Color altimetry map}
  ...
  \begin{subfigure}[t]{0.27\textwidth}
    \centering
    \includegraphics[height=0.4\paperheight]{figures/maps/ESP_020324_1555/DTEEC_020324_1555_020390_1555_U01-traversability_map.pdf}
    \caption{Traversability map}
...
\end{figure}
\par Finally, let us look at the landing site in Eberswalde crater. This section of the landing site looked relatively harmless at first.
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{figures/maps/ESP_020324_1555/DTEEC_020324_1555_020390_1555_U01-hist.pdf}
...
%     \centering
%     \includegraphics[height=0.5\paperheight]{figures/maps/ESP_023957_1755/DTEEC_023957_1755_024023_1755_U01.jpg}
%     \label{fig:southwest_dtm}
%     \caption{Color altimetry map}
%   \end{subfigure}
%   ~
%   \begin{subfigure}[t]{0.37\textwidth}
%     \centering
%     \includegraphics[height=0.5\paperheight]{figures/maps/ESP_023957_1755/DTEEC_023957_1755_024023_1755_U01-traversability_map.pdf}
%     \label{fig:southwest_traversability}
%     \caption{Traversability map}
%   \end{subfigure}
%   \label{fig:southwest}
...
\bibitem{bib:ESP_020324_1555}
  \url{www.uahirise.org/dtm/dtm.php?ID=ESP_020324_1555}
